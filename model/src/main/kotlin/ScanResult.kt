...
data class ScanResult(
    ...
    /**
     * Return a [ScanResult] whose [summary] contains only findings whose location / path is not matched by
     * any entry in [ignoreFilePaths].
     */
    fun filterByFilePath(ignoreFilePaths: Collection<String>): ScanResult {
        val matcher = FileMatcher(ignoreFilePaths.toList())
